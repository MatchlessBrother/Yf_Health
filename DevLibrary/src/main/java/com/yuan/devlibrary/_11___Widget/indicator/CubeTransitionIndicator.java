...
public class CubeTransitionIndicator extends BaseIndicatorController
{
    ...
    public void createAnimation()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            translationXAnim=ValueAnimator.ofFloat(startX,getWidth()-startX,getWidth()-startX, startX,startX);
            if (i==1)
            {
        ...
        scaleAnim=ValueAnimator.ofFloat(1,0.5f,1,0.5f,1);
        ...
        rotateAnim=ValueAnimator.ofFloat(0,180,360,1.5f*360,2*360);
    ...
    private ValueAnimator translationXAnim = null;
    private ValueAnimator translationYAnim = null;
    private ValueAnimator scaleAnim = null;
    private ValueAnimator rotateAnim = null;
    public void showView()
    {
        if(translationXAnim == null || translationYAnim == null ||scaleAnim == null || rotateAnim == null)
            createAnimation();
