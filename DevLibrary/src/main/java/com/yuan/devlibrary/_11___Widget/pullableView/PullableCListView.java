...
public class PullableCListView extends ListView implements Pullable
{
	private Boolean isCanPullDown = false;
	private Boolean isCanPullUp = false;
	
	public PullableCListView(Context context)
	{
		super(context);
	}

	public PullableCListView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public PullableCListView(Context context, AttributeSet attrs, int defStyle)
	{
