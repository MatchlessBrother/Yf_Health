        ...
        if (packageManager.hasSystemFeature(packageManager.FEATURE_CAMERA))
        {
            ...
            if(componentName != null)
            {
                ...
                if(cameraPermissionState == PackageManager.PERMISSION_GRANTED)
                {
                    ...
                    int storagePermissionState = ActivityCompat.checkSelfPermission(mActivity.getApplicationContext(), Manifest.permission_group.STORAGE);
                    ...
                    {
                        if(ActivityCompat.shouldShowRequestPermissionRationale(mActivity,Manifest.permission_group.STORAGE))
                            ActivityCompat.requestPermissions(mActivity,new String[]{Manifest.permission_group.STORAGE},REQUEST_CODE_PERMISSION_MEMORY);
                        else
