...
public abstract class BasePhotoFrag extends BaseFragment implements BaseMvp_View
{
    ...
    {
        PromptBoxUtils.showToast(getActivity(),str,strSize, TypedValue.COMPLEX_UNIT_SP, Gravity.CENTER,0);
    }
    ...
    {
        return PromptBoxUtils.showLoadingDialog(getActivity(),"请稍等",1,80,false,null);
    }
    ...
    {
        return PromptBoxUtils.showLoadingDialog(getActivity(),"请稍等",1,80,isCanceledOnTouchOutside,onClickOutsideListener);
    }
    ...
    {
        return PromptBoxUtils.showPromptDialog(getActivity(),titleStr, Color.argb(255,51,51,51), 36,TypedValue.COMPLEX_UNIT_SP,new ColorDrawable(0xffffffff),View.VISIBLE,
