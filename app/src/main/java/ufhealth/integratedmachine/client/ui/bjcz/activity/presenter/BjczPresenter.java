...
public class BjczPresenter extends BaseMvp_Presenter<BjczAct_V>
{
    public void disposeAlarm(String disposeAlarmOfDiscription,List<String> disposeAlarmOfImgs)
    {
        if(isAttachContextAndViewLayer())
        {
            ...
            putForm("content",disposeAlarmOfDiscription).putFilesPath(disposeAlarmOfImgs).convertForms().executeOfNet(getContext(),BjczModel.UploadData,new BaseMvp_LocalObjCallBack<BaseReturnData>(this)
            {
