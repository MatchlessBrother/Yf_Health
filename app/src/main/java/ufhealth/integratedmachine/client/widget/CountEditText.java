...
public class CountEditText extends RelativeLayout {
    ...
    {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.edittext_count, this, true);
        ...
        if (typedArray != null) {
            ...
            etContent.setMinHeight(px2dip(context,
                    typedArray.getDimensionPixelOffset(R.styleable.CountEditText_etMinHeight,200)));
            //最大字符
            ...
            etContent.setTextSize(px2sp(context,
                    typedArray.getDimensionPixelOffset(R.styleable.CountEditText_etTextSize,16)));
            //输入文字颜色
